...
CREATE TABLE IF NOT EXISTS `313_designs` (
...
INSERT INTO `313_designs` (`DesignID`, `Description`, `File`, `Categories`, `Name`, `Price`, `Available`, `Author`, `Material`) VALUES
...
CREATE TABLE IF NOT EXISTS `313_materials` (
...
INSERT INTO `313_materials` (`MaterialID`, `Name`, `CostPerCubicCM`, `MinimumThick`, `ExtraDetails`) VALUES
...
CREATE TABLE IF NOT EXISTS `313_orders` (
...
INSERT INTO `313_orders` (`OrderID`, `CreatedBy`, `OrderCost`, `ItemsOrdered`, `DateOrdered`, `Status`) VALUES
...
CREATE TABLE IF NOT EXISTS `313_users` (
...
INSERT INTO `313_users` (`UserID`, `Email`, `Password`, `ShippingAddress`, `FirstName`, `Surname`, `ContactNum`) VALUES
