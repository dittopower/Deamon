		...
		if($t == 0){ ?>
			...
			<form action="./patient.php" method="post">
				...
				<?php
					...
					$s = multiSQL("SELECT WardID FROM 201_wards",$mysqli);
				...
				<?php
					...
					$s = multiSQL("SELECT CONCAT(Firstname,' ',Lastname) AS name, StaffID FROM 201_staff WHERE Stafftype='Doctor'",$mysqli);
