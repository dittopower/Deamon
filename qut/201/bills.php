...
?>
	...
	<!-- CONTENT START -->
		...
		$rows = singleRowSQL("SELECT billID, Firstname, Lastname, MoneyOwed, Operation, OperationCost, Rebate, medicare is not null as eligable FROM 201_patientfinancial f natural join 201_prices c join 201_patients p on f.patientID = p.PatientNo where billID = '". $_GET['id']."'" ,$mysqli);
