...
if($_POST['do'] == 'Upload'){
	...
	$target_dir = $home."files/".$_SESSION['person']."/";
	...
	if ($uploadOk){
		echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded to <a href='//$_SERVER[HTTP_HOST]/files?$id'>$_SERVER[HTTP_HOST]/files?$id</a>.";
	}else{
