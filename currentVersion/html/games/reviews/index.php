			...
			if($value != NULL && $value >= 0){
				...
				switch($key){
					...
					case "steam":
						...
						echo "<span class='content'><ul><li><a href='https://store.steampowered.com/app/$value' target='_blank' rel='noopener'>Website</a></li>";
						echo "<li><a href='steam://store/$value'>Client</a></li></ul></span>"; 
						break;
					case "origin":
						echo "<h3>".ucwords($key)."</h3>";
						echo "<span class='content'><a href='https://www.origin.com/en-au/store/buy/$value' target='_blank' rel='noopener'>Website</a></span><br>";
						break;
					case "gog":
						echo "<h3>".ucwords($key)."</h3>";
						echo "<span class='content'><a href='https://www.gog.com/game/$value' target='_blank' rel='noopener'>Website</a></span><br>";
						break;
					case "developer":
						echo "<h3>".ucwords($key)."</h3>";
